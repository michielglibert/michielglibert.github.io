			...
			<Wrapper id="about" data-aos="fade">
				...
				<TextWrapper>
					...
					<AboutText>
						...
						afronden. De laatste 14 weken heb ik een stage gevolgd bij{" "}
					...
					<AboutText>
						...
						een goede groepsfeer! Uit teamwork haal ik enorm veel motivatie en
						dat geeft mijn productiviteit een boost.
					</AboutText>
					<AboutText>
						...
						vitamine D op de doen in mijn tuin. Kan ik er nog meer van genieten
